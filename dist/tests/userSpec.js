...
let user = new users_1.UserTable();
describe("Test user values", () => {
    it("check get-users endpoint retarn value", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield user.index();
    ...
    it("check show-user endpoint retarn value", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield user.show(5);
        let match = 0;
        let values = [
            5,
            "Mavis",
    ...
    it("check create-user endpoint retarn value", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("check update-user endpoint retarn value", () => __awaiter(void 0, void 0, void 0, function* () {
